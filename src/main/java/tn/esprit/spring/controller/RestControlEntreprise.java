...
import tn.esprit.spring.entities.dto.DtoEntreprise;
...
public class RestControlEntreprise {
	...
	@ResponseBody
	public int ajouterEntreprise(@RequestBody DtoEntreprise dtoentreprise) {
		Entreprise entreprise = DtoEntreprise.modelMap(dtoentreprise);
